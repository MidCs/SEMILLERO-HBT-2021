...
public class ComicDTO implements Serializable {
	...
	public ComicDTO(String string, String string2, String string3, TematicaEnum aventuras, String string4,
			Integer valueOf, BigDecimal valueOf2, String string5, boolean b, EstadoEnum activo, Long valueOf3) {
	 ...
	 */
	public com.bht.semillero.enums.EstadoEnum getEstadoEnum() {
		return estadoEnum;
	}
